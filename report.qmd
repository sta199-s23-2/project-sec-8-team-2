...
$$\widehat{wealth} = 2.8 - 0.159 * citizenship - 0.744 * energy + 0.881 * financial + 1.64 * new-sectors + 1.69 * non-traded-sectors + 1.27 * resource + 1.15 * traded-sectors $$
...
$$\widehat{wealth} = 4.61 - 2.79 * citizenship_euro - 0.0838 * energy - 1.76 * financial - 0.688 * new-sectors - 0.349 * non-traded-sectors - 0.145 * resource - 0.145 * traded-sectors + 3.67 * europe-financial + 3.25 * europe-new-sectors + 2.99 * europe-non-traded + 1.96 * eorupe-resource + 1.81 * europe-traded $$
