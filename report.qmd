...
Lastly, we created linear regression models, both additive and interaction based, and we found that...

Overall, our results show us that we were wrong to hypothesize that **financial** wealth relates to billionaires with higher net worths given that banking and finance have served the largest primary industries for up to 20.4% of the total billionaire population. As on average, the wealthiest billionaires are a product of an inheritance. Therefore, we were right in stating that inheritance is associated with a higher net worth. We were also correct in associating European citizenship with higher net worths.
