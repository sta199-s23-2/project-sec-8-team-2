...
```{r}
#l label: pie-citizenship

citizenship_prop_vec <- pull(citizenship_prop, prop_how)
citizenship_labs <- pull(citizenship_prop, location.citizenship)

citizenship_prop |>
  ggplot(
    aes(x = "", y = citizenship_prop_vec, fill = citizenship_labs)
  ) +
  geom_col(width = 1) +
  coord_polar(theta = "y") +
  labs(
    title = "Citizenship Proportions",
    x = "",
    y = "",
    fill = "Citizenship"
  ) +
