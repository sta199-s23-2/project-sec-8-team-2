...
Next, we wrangle the data. First, we remove spaces in variable names and coerce the variables to have valid names for our analysis.
...
\*Note that we opted not to include the regression model equations in our report
