...
6. Additionally, for each of our variables of interest, we compute the proportion of billionaires associated with each outcome. 
```{r}
...
7. Using the above data, we create pie chart visualizations. 
```{r}
