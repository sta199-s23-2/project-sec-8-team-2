...
billionaires_2014 |>
ggplot(aes(x = citizenship_euro, y = wealth.worth)) + geom_boxplot() +
labs(title = "Citizenship vs. Net Worth",
x = "Citizenship", y = "Net Worth")
...
billionaires_2014 |>
ggplot(aes(x = wealth.how.category, y = wealth.worth)) + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + geom_boxplot() +
labs(title = "Wealth Category vs. Net Worth",
x = "Wealth Category", y = "Net Worth")
...
billionaires_2014 |>
ggplot(aes(x = wealth.how.inherited, y = wealth.worth)) + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + geom_boxplot() +
labs(title = "Type of Inheritance vs. Net Worth",
x = "Inheritance", y = "Net Worth")
